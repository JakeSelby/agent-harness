...
raises asks, naming the error, instead of allowing. An agent write to a governance policy file, by
Bash or a file tool, is always asked about, and each governed decision is one `governance` row in
