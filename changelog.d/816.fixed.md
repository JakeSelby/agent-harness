...
it wrote in its own pull request, which the close-out lands itself, and it no longer archives while
that pull request is open. Before, nothing landed the filing's changes, so they were left unmerged
