...
- [Hit rate per rule](docs/usage.md): harness usage --rules reports how often each rule fired, by repository and by the variant you had selected, and every row names the profile that wrote it.
