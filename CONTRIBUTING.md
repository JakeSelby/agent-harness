...
comments as you would a reviewer's: push a fix, or reply with why one doesn't apply, then resolve
the thread, because `main` won't merge while a review thread is open. Comment `@coderabbitai
review` for another pass after you push. Its comments are advice, and where you disagree with it,
