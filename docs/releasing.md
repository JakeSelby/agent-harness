...
The 0.13.1 candidate requires fresh native qualification for Claude Code CLI on macOS and
Linux; until each carries evidence for this source, the preflight blocks publication. 0.13.0,
