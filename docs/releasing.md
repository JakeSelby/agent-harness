...
The 0.11.0 candidate requires fresh native qualification for Claude Code CLI and Codex CLI on
...
carries the immutable `v0.11.0` tag and the release workflow publishes it. Reference and
