...
Claude Code and Codex are this release's integration targets. The v0.10.0 stable support floor
qualifies their CLIs on macOS and Linux. The Claude Code and Codex VS Code surfaces and Codex
